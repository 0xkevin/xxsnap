...
1. XxSnap 1.2.0 中文版：Mac 截图、滚动长截图、贴图与本地 OCR 工具
...
在 XxSnap 1.2.0 里，你可以尽量在同一个流程中完成截图、标注、滚动长截图、贴图、本地识别和桌面讲解。
...
XxSnap 的贴图可以用滚轮或触控板缩放，缩放中心跟随指针。1.2.0 版本的上限为当前屏幕可用区域的 4 倍。图片超过屏幕后不强行塞回去，直接拖动查看其他位置即可。
...
6. 当前 1.2.0 版本所有功能都处于免费期，包括滚动截图、OCR 和教笔。
...
XxSnap 1.2.0 支持 macOS 14.0 及以上，同时兼容 Apple 芯片和 Intel Mac。当前版本全部功能免费。
...
XxSnap 1.2.0 当前全部功能免费，Apple 芯片和 Intel Mac 都能用。
...
贴图支持滚轮和触控板缩放、透明度、置顶、隐藏恢复及二次标注。XxSnap 1.2.0 的最大贴图显示尺寸为当前屏幕可用区域的 4 倍，超过屏幕后可直接拖动查看其他部分。
...
如果你想在 Mac 上更直接地完成截图、贴图和桌面标注，可以试试 XxSnap 1.2.0。它支持区域截图、全屏截图、滚动长截图、本地文字／二维码识别和教笔模式。
...
如果你受够了截图工具满屏按钮，可以试试 XxSnap。框好区域后，直接用滚轮或触控板截长图；开会讲界面时，你还能在当前桌面上画箭头、写字和打码。OCR 全程在本机完成，贴图最大能放到屏幕可用区域的四倍。XxSnap 1.2.0 当前全部功能免费。
...
| 比较项 | XxSnap 1.2.0 | Snipaste 2.x | PixPin 3.x | 推荐宣传口径 |
|---|---|---|---|---|
...
| 当前收费状态 | 1.2.0 全功能免费期 | 多项能力属于 PRO；2.x 商业使用需许可 | 大部分免费，部分功能需会员 | 只写“当前免费期”，不承诺永久免费 |
...
- XxSnap 功能事实：项目内置中英文帮助文档及 1.2.0 发布清单
